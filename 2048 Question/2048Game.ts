/* use the TS achived the 2048 game
...
let board: number[][] = [[null, null, null, 2], [null, null, null, 4], [null, 2, 2, 4], [null, 2, 4, 4]];
let newBoard: (number | null)[][] = [[], [], [], []];

//function to do the 2048 game
const move2048 = (arr: number[][], str: string): (number | null)[][] => {
  ...
  switch (str) {
    ...
    case "left":
      ...
      arr.forEach((itemArr) => {
        let stack: (number | null)[] = []; //use stack to check whether is same value grids
        ...
        //add the final answer into new Board
        for (let i = 0; i < itemArr.length; i++) {
    ...
    case "right":
      ...
      arr.forEach((itemArr) => {
        ...
        //Because the direction is right, so all the numbers should move to the right side
    ...
    case "up":
      ...
      for (let j = 0; j < arr[0].length; j++) {
        let stack: (number | null)[] = []; //stack for used meet the same grid value
        ...
        for (let i = 0; i < arr.length; i++) {
          ...
          //check whether meet the same value grid
...
/********************* Test case part ****************************/
console.log(move2048(board, "right"));
